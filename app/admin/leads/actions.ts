...
export async function updateLeadAction(leadId: string, formData: FormData) {
    try {
        const data = {
            ...
            estimatedPriceMin: formData.get('estimatedPriceMin') ? parseFloat(formData.get('estimatedPriceMin') as string) : null,
            estimatedPriceMax: formData.get('estimatedPriceMax') ? parseFloat(formData.get('estimatedPriceMax') as string) : null,
