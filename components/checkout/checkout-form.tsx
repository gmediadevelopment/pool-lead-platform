...
export function CheckoutForm({ orderSummary, userId }: CheckoutFormProps) {
    ...
    return (
        <Card>
            <CardHeader>
                <CardTitle className="text-lg">Zahlungsmethode wählen</CardTitle>
            </CardHeader>
            <CardContent className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <button
                        ...
                        className={`p-4 border-2 rounded-lg flex flex-col items-center gap-2 transition-all ${paymentMethod === 'stripe'
                    ...
                    <button
                        ...
                        className={`p-4 border-2 rounded-lg flex flex-col items-center gap-2 transition-all ${paymentMethod === 'paypal'
                                ? 'border-blue-600 bg-blue-50 dark:bg-blue-950'
                                : 'border-gray-200 hover:border-gray-300'
                            }`}
                    >
                        {/* PayPal Logo */}
                        <svg className="h-8 w-24" viewBox="0 0 124 33" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span className="text-xs text-muted-foreground">PayPal, Kreditkarte</span>
                    </button>
                </div>
...
// PayPal button component - loaded dynamically to avoid SSR issues
